...
insert into public.cultural_events (
  id, title, greek_title, event_type, venue_name, area, event_date,
...
select
  v.id, v.title, v.greek_title, v.event_type, v.venue_name, v.area,
...
from (values
  ('municipal-2026-saske-kyllini',
   ...
   'concert', 'Λιμάνι Κυλλήνης', 'Κυλλήνη', date '2026-08-09',
   'Δήμος Ανδραβίδας-Κυλλήνης',
  ...
  ('municipal-2026-full-moon-stafidokampos',
   ...
   'concert', 'Σταφιδόκαμπος', 'Σταφιδόκαμπος', date '2026-08-28',
   'Δήμος Ανδραβίδας-Κυλλήνης',
  ...
  ('municipal-2026-vlacherna-gastronomic',
   ...
   'festival', 'Αύλειος Χώρος Ιεράς Μονής Βλαχερνών', 'Κάτω Παναγιά', date '2026-09-06',
   'Δήμος Ανδραβίδας-Κυλλήνης',
  ...
  ('municipal-2026-vouprasia-closing',
   ...
   'festival', 'Πλατεία Βάρδας', 'Βάρδα', date '2026-06-27',
   'Δήμος Ανδραβίδας-Κυλλήνης',
  ...
  ('municipal-2026-anthestiria-gastouni',
   ...
   'festival', 'Πλατεία Ελευθερίας', 'Γαστούνη', date '2026-05-15',
   'Δήμος Πηνειού',
  ...
  ('municipal-2026-traganos-carnival',
   '27th Traganos Carnival Parade', '27ο Τραγανέικο Καρναβάλι',
   'festival', 'Κεντρική πλατεία Τραγανού', 'Τραγανό', date '2026-03-17',
   'Δήμος Πηνειού',
  ...
  ('municipal-2026-ilida-revue',
   ...
   'theater', 'Αρχαίο Θέατρο Ήλιδας', 'Αρχαία Ήλιδα', date '2026-07-21',
   'Δήμος Ήλιδας',
  ...
  ('municipal-2026-ilida-antigone',
   ...
   'theater', 'Αρχαίο Θέατρο Ήλιδας', 'Αρχαία Ήλιδα', date '2026-08-01',
   'Δήμος Ήλιδας',
  ...
  ('municipal-2026-ilida-full-moon',
   ...
   'concert', 'Αίθριο Νέου Μουσείου Ήλιδας', 'Αρχαία Ήλιδα', date '2026-08-28',
   'Δήμος Ήλιδας',
   ...
   false)
) as v(id, title, greek_title, event_type, venue_name, area, event_day,
