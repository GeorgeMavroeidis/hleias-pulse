...
const EL: Record<string, string> = {
  ...
  "Write your answer…": "Γράψε την απάντησή σου…",
  "Write your answer": "Γράψε την απάντησή σου",
  Answers: "Απαντήσεις",
  Comments: "Σχόλια",
  Share: "Κοινοποίηση",
  ...
  "Question posted": "Η ερώτηση δημοσιεύτηκε",
  ...
  "Ask something about this place…": "Ρώτα κάτι για αυτό το μέρος…",
  Ask: "Ρώτα",
  "No answers yet": "Χωρίς απάντηση ακόμα",
  "{n} answer": "{n} απάντηση",
  "{n} answers": "{n} απαντήσεις",
  Question: "Ερώτηση",
  ...
  "posts today": "δημοσιεύσεις σήμερα",
  "events tonight": "εκδηλώσεις απόψε",
  "local notes": "σημειώσεις κατοίκων",
  ...
  "Show the QR or the code at the counter.": "Δείξε το QR ή τον κωδικό στο ταμείο.",
  "One use": "Μία χρήση",
  "Valid until": "Ισχύει έως",
  "The code expired": "Ο κωδικός έληξε",
  Expired: "Έληξε",
  Expires: "Λήγει",
  Copy: "Αντιγραφή",
  Copied: "Αντιγράφηκε",
